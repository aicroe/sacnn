    ...
    def __init__(
        ...
        with graph.as_default():
            ...
            layer2_weights = tf.Variable(tf.truncated_normal(
                [reshape_size, num_labels],
                stddev=0.1),
            )
            layer2_bias = tf.Variable(tf.zeros([num_labels]))
